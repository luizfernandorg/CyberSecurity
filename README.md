...
### download community rules for snort 3
- snort_update.sh

### finally execute snort
but before start is better to set network or ip as HOME_NET
and then set EXTERNAL_NET="!HOME_NET" in the file /usr/local/etc/snort/snort.lua
